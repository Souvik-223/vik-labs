  ...
  return (
    <section className="container">
      <div className="grid grid-cols-[12.5rem_1fr] max-[56.25rem]:grid-cols-1 gap-[3.75rem] max-[56.25rem]:gap-6 py-[3.75rem] max-[56.25rem]:py-10 border-b border-vl-line">
        <div className="mono text-xs text-vl-fg-muted reveal reveal--left">§ 04 / Words</div>
        <div>
          <p className="text-[clamp(1.25rem,2.2vw,1.75rem)] font-normal tracking-[-0.015em] leading-[1.35] text-vl-fg max-w-[32ch] mb-6 reveal reveal--fade">
          ...
          <div
            className="mono text-xs text-vl-fg-dim flex items-center gap-3 reveal"
