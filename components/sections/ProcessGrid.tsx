    ...
    <section className="py-20 max-[56.25rem]:py-[3.75rem] border-b border-vl-line" id="process">
      <div className="container">
        <div className="grid grid-cols-[12.5rem_1fr] max-[56.25rem]:grid-cols-1 gap-[3.75rem] max-[56.25rem]:gap-4 mb-12 max-[56.25rem]:mb-8 items-start">
          <div className="mono text-xs text-vl-fg-muted reveal reveal--left">§ 03 / Process</div>
          <div>
        ...
        <div className="grid grid-cols-4 max-[56.25rem]:grid-cols-1 border border-vl-line rounded-md overflow-hidden">
          {STEPS.map((s, i) => (
            <div
              key={s.step}
              className="bg-vl-bg-2 p-6 border-r border-vl-line last:border-r-0 max-[56.25rem]:border-r-0 max-[56.25rem]:border-b max-[56.25rem]:border-vl-line max-[56.25rem]:last:border-b-0 transition-colors duration-200 hover:bg-vl-bg-3 flex flex-col gap-3 reveal"
