    ...
    <header className="pt-[8.75rem] pb-20 max-[56.25rem]:pt-[6.875rem] max-[56.25rem]:pb-[3.75rem] border-b border-vl-line">
      <div className="container grid grid-cols-[1.4fr_1fr] max-[56.25rem]:grid-cols-1 gap-20 max-[56.25rem]:gap-10 items-end">
        ...
        <div className="reveal">
          <div className="mono text-[0.6875rem] text-vl-fg-muted uppercase tracking-[0.08em] inline-flex items-center gap-2 mb-7 before:content-[''] before:w-1 before:h-1 before:bg-vl-accent before:rounded-full before:shrink-0">
            VL—001 · Studio
          </div>
          <h1 className="text-[clamp(2.25rem,5vw,4rem)] font-medium tracking-[-0.025em] leading-[1.05] mb-6 max-w-[16ch]">
            Engineering, film &amp; story<br/>
            for products <span className="dim">that need to ship,</span>{' '}
            <span className="acc">then sell.</span>
          </h1>
          <p className="text-[1.0625rem] leading-[1.55] text-vl-fg-dim max-w-[52ch] mb-8">
        ...
        <aside className="border border-vl-line rounded-md bg-vl-bg-2 overflow-hidden reveal">
